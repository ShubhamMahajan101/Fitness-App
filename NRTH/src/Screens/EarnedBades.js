        ...
        <View style={{ flex: 1, }}>
            ...
            <View style={{ flex: 1, backgroundColor: Colors.backgroundcolor }}>
                            ...
                            <View >
                                <View style={{
                                    ...
                                    <View style={{ flexDirection: 'row', marginRight: mobileW * 6 / 100 }}>
                                        ...
                                        }}>{moment(responseData.CreateuserBadges.updatedAt).format("DD-MM-YYYY")}</Text>
                                    </View>
                                </View>
                                <View style={{ flexDirection: "row", justifyContent: 'space-between', marginTop: mobileW * 1 / 100 }}>
                                    <View style={{ marginTop: Platform.OS == "ios" ? mobileW * 4 / 100 : 0, width: mobileW * 39 / 100, height: mobileW * 15 / 100, }}>
                                        ...
                                        }}>{responseData.CreateuserBadges.avgExerciseCount}</Text>
                                        <View style={{
                                    ...
                                    <View style={{ marginTop: Platform.OS == "ios" ? mobileW * 3.5 / 100 : mobileW * 0 / 100, width: mobileW * 39 / 100, height: mobileW * 15 / 100, }}>
                                        ...
                                        }}>{responseData.CreateuserBadges.dayCount}</Text>
                    ...
                    {recordData.levels.name.toLowerCase() == "savage" &&
                        <ImageBackground resizeMode='contain' imageStyle={{ width: mobileW * 80 / 100, height: mobileW * 80 / 100, borderRadius: mobileW * 5 / 100, }} style={{
                            ...
                            <View>
                                ...
                                <Text style={{ fontSize: mobileW * 3 / 100, textAlign: "center", marginTop: mobileW * 5 / 100, fontFamily: Font.FontRegularFono, color: Colors.lightAccent, }}>{moment(responseData.CreateuserBadges.updatedAt).format("DD-MM-YYYY")}</Text>
                            </View>
                        </ImageBackground>
                    }
                </ScrollView>
                ...
                <View style={styles.completeButton}>
                    <SmallButton
                        onPressClick={() => {
                            _SaveClaimApiCalling();
                        }}
                        navigation={navigation} screenName={'DailyworkoutCompleted'} title={Lang_chg.saveInProfile}></SmallButton>
                </View>
            </View>
        </View>
    )
}
export default EarnedBades;
