            ...
            <Modal
                ...
                <View style={{ flex: 1, backgroundColor: '#00000030', alignItems: 'center' }}>
                    <View style={{ position: 'absolute', bottom: 25, width: screenWidth, }}>
                        <View style={{ backgroundColor: Colors.backgroundcolor, borderRadius: 15, width: '94%', paddingVertical: mobileW * 3.3 / 100, alignSelf: 'center' }}>
                            <TouchableOpacity
                            >
                                <Text style={{ color: Colors.whiteColor, fontSize: 17, alignSelf: 'center', fontFamily: Font.FontRegular }}>{Lang_chg.selectOptiontxt[config.language]}</Text>
                            </TouchableOpacity>
                            ...
                            >
                                <Text style={{ color: "red", fontSize: 18, alignSelf: 'center', fontFamily: Font.FontRegular, marginTop: 10, }}>{Lang_chg.cancelmedia[config.language]}</Text>
                            </TouchableOpacity>
